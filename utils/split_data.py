...
x.drop(columns="index", inplace=True)  # TODO is this only necessary for 2 channels?
...
# X_train.to_csv(f"data_preprocessed/split_data/X_train_{sensors_names}.csv", index=False)
# X_test.to_csv(f"data_preprocessed/split_data/X_test_{sensors_names}.csv", index=False)
# y_train.to_csv(f"data_preprocessed/split_data/y_train_{sensors_names}.csv", index=False)
# y_test.to_csv(f"data_preprocessed/split_data/y_test_{sensors_names}.csv", index=False)